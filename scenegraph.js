...
//gsap.to(container, { x: 100, duration: 1, repeat: -1, ease: 'none', yoyo: true });
...
// gsap を使うと、xy座標指定はグローバル座標になってしまう。
gsap.to(box1, { x: 1, duration: 1, repeat: -1, ease: 'none', yoyo: true,
   });
